...
parser.add_argument(
    ...
    "--checkpoint",
    type=str,
    default="./work_dir/medsam_vit_b.pth",
...
img_paths = glob(join(args.data_path, '*.jpg'))
...
for file in tqdm(img_paths):
    ...
    io.imsave(
        join(args.seg_path, "seg_" + os.path.basename(file)),
...
plt.savefig(join(args.seg_path, "segmented_image.jpg"))
